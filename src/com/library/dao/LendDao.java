...
public class LendDao {
    ...
    public int selectLend(long book_id) {
        return sqlSessionTemplate.selectOne(NAMESPACE + "lendBookList", book_id);
    }

    public int selectReaderId(long reader_id) {
        return sqlSessionTemplate.selectOne(NAMESPACE + "readerIdList", reader_id);
    }
